...
<footer>
    ...
    <div class="copyright">
        <span class="left copy">MonoX is a <a href="http://mono.software">Mono</a> product.</span>
        <a href="http://mono.software" class="right branding"><img id="Img1" src="~/App_Themes/Default/img/mono-color.svg" alt="mono" runat="server" /></a>
    </div>
</footer>