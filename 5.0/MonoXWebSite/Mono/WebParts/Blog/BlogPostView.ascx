<%@ Control Language="C#" AutoEventWireup="true" Inherits="Mono.Web.Parts.Blog.BlogPostView" Codebehind="BlogPostView.ascx.cs" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<%@ Register TagPrefix="MonoX" TagName="BlogComments" Src="~/Mono/WebParts/Blog/BlogComments.ascx" %>
