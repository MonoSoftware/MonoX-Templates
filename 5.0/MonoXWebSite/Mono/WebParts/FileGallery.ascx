<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="FileGallery.ascx.cs"
    Inherits="Mono.Web.Parts.FileGallery" %>
...
<asp:Panel ID="pnlContainer" runat="server">
    <asp:PlaceHolder ID="panTitle" runat="server" Visible="false">
        <asp:Literal ID="labTitle" runat="server" Text="<%$ Code: MonoSoftware.MonoX.Resources.SocialNetworkingResources.FileGallery_AttachedFiles %>" Visible="false"></asp:Literal>
    </asp:PlaceHolder>
