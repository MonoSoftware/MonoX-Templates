<%@ Page Language="C#" AutoEventWireup="true" Inherits="MonoSoftware.MonoX.Admin.PageManagerNavigationRoles" EnableTheming="true" Codebehind="PageManagerNavigationRoles.aspx.cs" Theme="DefaultAdmin" %>
            ...
            <div class="content"> 
                <dl>
                    <dd class="checkboxes">
                        ...
                        <asp:CheckBoxList BorderStyle="None" BorderWidth="0px" ID="chkRoles" runat="server" DataTextField="RoleName" DataValueField="RoleId" RepeatLayout="UnorderedList"></asp:CheckBoxList>
                    </dd>
                </dl>
             </div>
         </asp:Panel>    
         <div class="footer">
            <asp:Button ID="btnSave" runat="server" AccessKey="S" OnClick="btnSave_Click" CssClass="AdminButton" Text='<%$ Code: AdminResources.Button_Save %>' /> 
