<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageManagerRegisterPage.aspx.cs" EnableTheming="true" Inherits="MonoSoftware.MonoX.Admin.PageManagerRegisterPage" Theme="DefaultAdmin" %>
    ...
    <asp:Panel CssClass="CssForm" runat="server" ID="pnlContainer">
        ...
        <dd class="drop-holder">
            ...
            <telerik:RadCodeBlock id="radCodeBlock2" runat="server">
                <img onclick="ToggleTreeView()" src='<%= GetImgPath("DropArrow.gif") %>'  class="toggle-button"/></telerik:RadCodeBlock>
            <div id="treeDiv">
        ...
        <dd class="jq_FieldValidatorWrapper">
            ...
            <asp:RequiredFieldValidator id="rfvPageTitle" Runat="server" CssClass="validator" Display="Dynamic" Text="!" ControlToValidate="txtPageTitle" ValidationGroup="mainVg"></asp:RequiredFieldValidator>
        </dd>
        <dd>
