...
<div class="AdminContainer">
    <monox:GridViewEditBox ID="gridViewBox" runat="server" ShowTopActions="true" ValidationGroup="Blog">
        ...
        <ContentTemplate>
            ...
            <div  class="AdminGridFooterContent admin-edit-form blog-settings-holder">
                <mono:BlogSettings runat="server" ID="ctlBlogSettings" IsRequired="true" ShowActions="false"></mono:BlogSettings>
            </div>
            </asp:PlaceHolder>
        </ContentTemplate>
