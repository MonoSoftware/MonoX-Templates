<%@ Page Language="C#" 
AutoEventWireup="True" CodeBehind="Albums.aspx.cs" 
Inherits="MonoSoftware.MonoX.Admin.Albums" 
        ...
        <div class="admin-row">
            ...
            <div class="admin-content">
                <div class="spacer-sml">
                    <h4 class="analytics-title"><%= AdminResources.Analytics_Albums_Title %></h4>
                    <div class="graph">
                ...
                <div class="admin-quarter-width spacer-med">
                    <div class="box-data-display">
                        ...
                        <span class="box-data-label"><%= AdminResources.Analytics_Albums_Total %></span>
                    </div>
                </div>
            </div>
        </div>
