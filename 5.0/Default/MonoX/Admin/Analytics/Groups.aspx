<%@ Page Language="C#" 
AutoEventWireup="True" CodeBehind="Groups.aspx.cs" 
Inherits="MonoSoftware.MonoX.Admin.Groups" 
        ...
        <div class="admin-row">
            ...
            <div class="admin-content">
                ...
                <div class="spacer-sml">
                    <h4 class="analytics-title"><%= AdminResources.Analytics_Groups_Title %></h4>
                    <div class="graph">
                ...
                <div class="admin-row">
                    <div class="admin-quarter-width spacer-med">
                        <div class="box-data-display">
                            ...
                            <span class="box-data-label"><%= AdminResources.Analytics_Groups_Total %></span>
                        </div>
                    </div>
                </div>
