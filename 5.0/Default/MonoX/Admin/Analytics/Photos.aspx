<%@ Page Language="C#" 
AutoEventWireup="True" CodeBehind="Photos.aspx.cs" 
Inherits="MonoSoftware.MonoX.Admin.Photos" 
        ...
        <div class="admin-row">
            ...
            <div class="admin-content">
                ...
                <div class="spacer-sml">
                    <h4 class="analytics-title"><%= AdminResources.Analytics_Photos_Title %></h4>
                    <div class="graph">
                ...
                <div class="admin-row">
                    <div class="admin-quarter-width spacer-med">
                        <div class="box-data-display">
                            ...
                            <span class="box-data-label"><%= AdminResources.Analytics_Photos_Total %></span>
                        </div>
                    </div>
                </div>
