<%@ Page Language="C#" 
AutoEventWireup="True" CodeBehind="Events.aspx.cs" 
Inherits="MonoSoftware.MonoX.Admin.Events" 
        ...
        <div class="admin-row">
            ...
            <div class="admin-content">
                <div class="spacer-sml">
                    <h4 class="analytics-title"><%= AdminResources.Analytics_Events_Title %></h4>
                    <div class="graph">
                ...
                <div class="admin-row">
                    <div class="admin-quarter-width spacer-med">
                        <div class="box-data-display">
                            ...
                            <span class="box-data-label"><%= AdminResources.Analytics_Events_Total %></span>
                        </div>
                    </div>
                </div>
            </div>
