<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FileAdminAzure.aspx.cs" Inherits="MonoSoftware.MonoX.Admin.FileAdminAzure" MasterPageFile="~/MonoX/MasterPages/AdminDefault.master" EnableTheming="true" Theme="DefaultAdmin" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cp" Runat="Server">
    ...
    <div class="fileExplorerContainer">
        <center>
            <telerik:RadFileExplorer Skin="MetroTouch" OnClientFileOpen="OnFileOpen" runat="server" ID="ctlFileExplorer" Width="100%" Height="600px" CssClass="fileExplorer">
