...
<body>
    ...
    <div class="popup-box">
        ...
        <div class="content manage-template">
            <dl>
                <dd class="choose-skin">
                    <label><asp:Label ID="lblSkin" runat="server" Text='<%$ Code: AdminResources.PageManagerPageTemplates_lblSkin %>' AssociatedControlID="ddlSkins"></asp:Label></label>
                    ...
                    <asp:Repeater runat="server" ID="rptTemplates">
                        <ItemTemplate>
                            <div class="template-screen">
                                ...
                                <asp:Image runat="server" ImageUrl='<%# Eval("ThumbnailUrl").ToString() %>' ImageAlign="Middle" />
                ...
                <dd class="RadUploadContainer RadUploadContainerPopup">
                    <label><asp:Label ID="lblUpload" runat="server" Text='<%$ Code: AdminResources.PageManagerPageTemplates_lblUpload %>'></asp:Label></label>
