...
<div class="user-score">
    <%= DependencyInjectionFactory.Resolve<MonoSoftware.MonoX.BusinessLayer.IUserProfileBLL>().GetUserReputation(UserId) %>
...
<asp:PlaceHolder ID="plhHidden" runat="server" Visible="false">
    ...
    <radU:RadToolTip ID="wndUpload" runat="server" RelativeTo="Element" TargetControlID="rowGravatar"
        ...
        <asp:PlaceHolder runat="server" ID="plhCropImage">
            <monox:CropImage  runat="server" ID="cropImage" UseBase64ImageEncoding="true" CropMinSizeWidth="<%$ Code: MonoSoftware.MonoX.ApplicationSettings.ThumbnailSizeDefaults.Medium %>" 
            CropMinSizeHeight="<%$ Code: MonoSoftware.MonoX.ApplicationSettings.ThumbnailSizeDefaults.Medium %>" DesiredImageWidth="<%$ Code: MonoSoftware.MonoX.ApplicationSettings.ThumbnailSizeDefaults.Medium %>"
            DesiredImageHeight="<%$ Code: MonoSoftware.MonoX.ApplicationSettings.ThumbnailSizeDefaults.Medium %>" />
        </asp:PlaceHolder>
        </div>
    </radU:RadToolTip>
</asp:PlaceHolder>