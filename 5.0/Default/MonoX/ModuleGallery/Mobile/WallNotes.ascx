        ...
        <ContentTemplate>
            <asp:Panel runat="server" ID="pnlNoteEdit">
                <div class="social-network">
                    ...
                    <MonoX:HTML5Upload runat="server" ID="ctlUpload" EnableFileGallery="false" CssClass="wall-file-upload" Visible="false" />
                    <MonoX:FileGallery ID="ctlFileGallery" runat="server" Visible="false" />
                </div>
            </asp:Panel>
