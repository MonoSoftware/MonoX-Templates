...
<asp:Panel ID="pnlContainer" runat="server">
    <div class="rad-upload-container rad-upload-standalone">
        <radU:RadUpload ID="radUpload" runat="server" InitialFileInputsCount="1" OverwriteExistingFiles="true" Skin="MetroTouch" />
