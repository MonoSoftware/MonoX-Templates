...
<asp:Content ID="Content2" ContentPlaceHolderID="cp_cnt" Runat="Server">
    ...
    <div class="installer-default">
        <div>
            <h5><asp:Literal ID="labRequirements" runat="server" Text='<%$ Code: InstallerResources.Default_labRequirements %>'></asp:Literal></h5>
        </div>
        <ul>
            <li>
                <strong><asp:Literal ID="labMSNet" runat="server" Text='<%$ Code: InstallerResources.Default_labMSNet %>'></asp:Literal></strong>
                <asp:Label ID="labMSNetInfo" runat="server" CssClass="item_info" Text='<%$ Code: InstallerResources.Default_labMSNetInfo %>'></asp:Label>                 
            ...
            <li>
                <strong><asp:Literal ID="labIIS" runat="server" Text='<%$ Code: InstallerResources.Default_labIIS %>'></asp:Literal></strong>
                <asp:Label ID="labIISInfo" runat="server" CssClass="item_info" Text='<%$ Code: InstallerResources.Default_labIISInfo %>'></asp:Label>
    ...
    <div class="note-holder">
        <%= String.Format(InstallerResources.InstallComplete_Note, System.Security.Principal.WindowsIdentity.GetCurrent().Name) %>
    </div>
    </div>
