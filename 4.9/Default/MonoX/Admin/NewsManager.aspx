                            ...
                            <rad:RadMultiPage ID="multiPageNewsItems" runat="server" CssClass="page-news">
                                ...
                                <dl class="news-list news-list-labels">
                                    ...
                                    <dd class="full-width">
                                        ...
                                        <mono:CustomRadEditor id="radNewsShortContent" EditorHeight="300px" AutoResizeHeight="False" runat="server" Width="100%"></mono:CustomRadEditor>
                                    </dd>
                                    <dd class="full-width">
                                        <asp:Label ID="labNewsContent" runat="server" Text='<%$ Code: AdminResources.NewsManager_labNewsContent %>'></asp:Label>    
                                        <mono:CustomRadEditor id="radNewsContent" EditorHeight="300px" AutoResizeHeight="False" runat="server" Width="100%" ></mono:CustomRadEditor>
                                    </dd>
                                </dl>
                            </rad:RadPageView>
