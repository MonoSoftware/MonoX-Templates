            ...
            <div class="AdminGridFooterContent admin-edit-form">
                <dl>
                    ...
                    <dd>
                        ...
                        <rad:RadDatePicker ID="radValidFrom" IsRequired="true" runat="server" Skin="Silk"></rad:RadDatePicker>
                    </dd>
                    <dd>
                        <label><asp:Literal ID="labValidTo" runat="server" Text='<%$ Code: AdminResources.AdAdmin_labValidTo %>'></asp:Literal></label>
                        <rad:RadDatePicker ID="radValidTo" runat="server" Skin="Silk"></rad:RadDatePicker>
                    </dd>
                    <dd class="chkbox">
