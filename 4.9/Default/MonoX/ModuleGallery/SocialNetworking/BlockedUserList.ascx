...
<div class="block-user">
    <asp:Panel ID="pnlSearch" runat="server" CssClass="PeopleSearch" DefaultButton="btnFilter">
        <div class="block-user-list">
            ...
            <MonoX:StyledButton runat="server" ID="btnFilter" CausesValidation="false" OnClick="btnFilterUsers_Click" Text="Filter" cssClass="secondary" />
            <MonoX:StyledButton runat="server" ID="btnClear" CausesValidation="false" OnClick="btnClearFilterUsers_Click" Text="Clear" cssClass="secondary" />
        </div>
    </asp:Panel>
