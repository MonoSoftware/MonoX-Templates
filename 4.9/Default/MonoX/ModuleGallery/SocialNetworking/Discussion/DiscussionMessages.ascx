    ...
    <div class="discussion">
        ...
        <asp:PlaceHolder ID="plhReply" runat="server">
                ...
                <dl class="post-imput">
                    ...
                    <dd class="discussion-form tags-holder">
                        <table cellpadding="0" cellspacing="0" width="100%" class="snNoteTable">
                            <tr class="snUploadRow">
                                <td>
                                    <asp:Label ID="lblAttachments" AssociatedControlID="ctlUpload" runat="server"><%=  MonoSoftware.MonoX.Resources.SocialNetworkingResources.Discussion_Attachments  %></asp:Label>
