            ...
            <ContentTemplate>
                ...
                <asp:Panel ID="rowStatus" runat="server" CssClass="status-wrapper">
                    ...
                    <div class="user-score">
                        ...
                        <h2><%= MonoSoftware.MonoX.BusinessLayer.UserProfileBLL.GetInstance().GetUserReputation(UserId) %>
                        <!--<span><%= MonoSoftware.MonoX.Resources.UserProfileResources.UserScore %></span>--></h2>
                    </div>
...
<div id="admin-choose-a-user" class="content-wrapper">
    <div class="main-content">
        <asp:Panel ID="rowAdmin" runat="server" class="choose-a-user" Visible="false">
            ...
            <telerik:RadComboBox ID="ddlUsers" runat="server" AllowCustomText="false" EnableLoadOnDemand="True" Skin="MetroTouch" 
