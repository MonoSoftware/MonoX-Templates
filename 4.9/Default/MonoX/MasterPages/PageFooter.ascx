...
<footer>
    <div class="footer-holder">
        ...
        <ul class="footer-box social-box">
            <li><h2><%= PageResources.PageFooter_ConnectWithUs %></h2></li>
            <li><span class="facebook"></span><a href="http://www.facebook.com/pages/Mono-Software-Ltd/192570507442137"><%= PageResources.PageFooter_FacebookFan %></a></li>
            <li><span class="twitter"></span><a href="https://twitter.com/monosoftware"><%= PageResources.PageFooter_TwitterFollow %></a></li>
            <li><span class="linkedin"></span><a href="http://hr.linkedin.com/company/mono-software-ltd."><%= PageResources.PageFooter_LinkedInConnect %></a></li>
        </ul>
    </div>
    <div class="copyright">
        <a id="A1" runat="server" href="http://monox.mono-software.com" class="powered-by">Powered by MonoX, </a>
        <span><%= PageResources.PageFooter_Copyright%> &#169;<%= DateTime.UtcNow.Year.ToString()%> <a href="http://www.mono-software.com">Mono Ltd.</a></span>
    </div>
</footer>