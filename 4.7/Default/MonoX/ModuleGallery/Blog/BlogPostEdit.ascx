...
<asp:Panel runat="server" ID="pnlContainer">
    <div class="blog-edit-settings input-form">
        ...
        <dl>
            ...
            <dd>
                <asp:Label ID="lblDatePublished" AssociatedControlID="txtDatePublished" runat="server" CssClass="label" style="float: left;"></asp:Label><br />
                <mono:DatePicker ID="txtDatePublished" Runat="server"></mono:DatePicker>
            </dd>
            <dd>
