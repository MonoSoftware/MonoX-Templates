                        ...
                        <div class="input-form">
                            <dl>
                                ...
                                <dd class="button-holder">
                                    <asp:LinkButton ID="lnkUpdate" runat="server" CausesValidation="false" CommandArgument='<%# Eval("Id") %>' CommandName="Update" Text='<%# DefaultResources.Button_Update %>' CssClass="styled-button"></asp:LinkButton>
        ...
        <div class="bottom-section">
            <div class="inner clearfix">
                <asp:PlaceHolder id="plhActions" Runat="server">
                    <asp:Button id="btnAdd" runat="server" CausesValidation="true" CssClass="styled-button float-left" OnClick="lnkAdd_Click"/>
                    <asp:Button id="btnSave" runat="server" CausesValidation="true" ValidationGroup="Modification" CssClass="styled-button styled-button-blue float-right" OnClientClick="javascript:CloseWindow()" />
                </asp:PlaceHolder>
