...
<div class="message-center">
    <div class='sort-filter <%= MonoSoftware.MonoX.Utilities.SecurityUtility.IsAdmin() ? "administrator-mode" : "" %>'>
        ...
        <div class="sorting">
            <div class="from styled-button" style='<%= MessageStatusFilter == MonoSoftware.MonoX.Repositories.MessageStatus.Received ? String.Empty : "display: none;"%>'>
            ...
            <div class="to styled-button" style='<%= MessageStatusFilter == MonoSoftware.MonoX.Repositories.MessageStatus.Sent ? String.Empty : "display: none;"%>'>
            ...
            <div class="subject styled-button">
