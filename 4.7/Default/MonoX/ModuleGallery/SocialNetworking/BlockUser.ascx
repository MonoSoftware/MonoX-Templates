...
<div class="people-search input-form">
    ...
    <asp:Panel ID="pnlActionPanel" runat="server" CssClass="jq_monoxPeopleSearchCommand">
        <MonoX:StyledButton runat="server" ID="btnBlock" CausesValidation="true" OnClick="btnBlock_Click" />
        <MonoX:StyledButton runat="server" ID="btnViewProfile" CausesValidation="false" OnClick="btnViewProfile_Click" />
