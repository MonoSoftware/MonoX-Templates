...
<div class="block-user-list">
    ...
    <MonoX:StyledButton runat="server" ID="btnFilter" CausesValidation="false" OnClick="btnFilterUsers_Click" Text="Filter" />
    <MonoX:StyledButton runat="server" ID="btnClear" CausesValidation="false" OnClick="btnClearFilterUsers_Click" Text="Clear" />
</div>
</asp:Panel>
