...
<div class="contact-us input-form">
    <div class="span8">
        ...
        <dl>
            ...
            <dd>
                <asp:LinkButton ID="btnSend" runat="server" CausesValidation="true" OnClick="btnSend_Click" CssClass="styled-button" />
            </dd>
        </dl>
    </div>
    <div ID="panInfo"  runat="server" class="span4">
        <div class="contact-info">
            <div class="inner">
                <h3><%# DefaultResources.ContactForm_ContactInfoTitle %></h3>
                <asp:PlaceHolder ID="panWebSiteName" runat="server"><strong><%# A_WebSiteName%></strong><span>&nbsp;</span></asp:PlaceHolder>
