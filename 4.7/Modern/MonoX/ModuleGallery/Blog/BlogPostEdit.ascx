    ...
    <div class="blog-edit-settings">
        ...
        <dl>
            ...
            <dd class="categories jq_FieldValidatorWrapper">
                ...
                <asp:RequiredFieldValidator ID="requiredTitle" runat="server" CssClass="validator" ControlToValidate="txtTitle" SetFocusOnError="true" Display="Dynamic" ></asp:RequiredFieldValidator>
            </dd>        
            <dd class="categories jq_FieldValidatorWrapper">
                <div class="edit-title">  
