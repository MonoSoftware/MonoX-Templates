    ...
    <div class="intro-background-picture">
        <div class="intro-wrapper">
            ...
            <div class="intro-image">
                <img id="Img3" src="~/App_Themes/Modern/img/banner-image.png" runat="server" />
            </div>
        </div>
    </div>
    ...
    <portal:PortalWebPartZoneTableless ID="middlePartZone" runat="server" Width="100%" ChromeTemplateFile="Standard.htm" HeaderText='<%$ Code: PageResources.Zone_MiddlePartZone %>'>
            <ZoneTemplate>
                <MonoX:Editor runat="server" ID="editor3" Title='<%$ Code: PageResources.Title_MiddleSection %>' DefaultDocumentTitle='<%$ Code: PageResources.Title_MiddleSection %>'>
                    <DefaultContent>
                                <h2>Monox. Fast. Powerful. Flexible. <em>And it comes at the price you cannot beat.</em></h2>
            ...
            <MonoX:Editor runat="server" ID="editor2" Title='<%$ Code: PageResources.Title_TopSection %>' DefaultDocumentTitle='<%$ Code: PageResources.Title_TopSection %>'>
                <DefaultContent>
                    <div class="box highlited">
                        <div class="highlited-image"><img src="~/App_Themes/Modern/img/content-icons/bubble-icon.png" /></div>
                    ...
                    <div class="box highlited">
                        <div class="highlited-image"><img src="~/App_Themes/Modern/img/content-icons/doc-icon.png" /></div>
                        <div class="highlited-text">
                    ...
                    <div class="box highlited">
                        <div class="highlited-image"><img src="~/App_Themes/Modern/img/content-icons/badge-icon.png" /></div>
                        <div class="highlited-text">
                            <h3>What's New</h3>
    ...
    <div id="featured-projects" class="content-wrapper">
        <div class="main-content">
            ...
            <div class="home-slider">
                <ul data-orbit>
                    <li>
                        <img runat="server" src="~/App_Themes/Modern/img/Projects/project-1.jpg" />
                        <div class="orbit-caption">Caption</div>
                    </li>
                    <li>
                        <img id="Img1" runat="server" src="~/App_Themes/Modern/img/Projects/project-2.jpg" />
                        <div class="orbit-caption">Caption</div>
                    </li>
                    <li>
                        <img id="Img2" runat="server" src="~/App_Themes/Modern/img/Projects/project-3.jpg" />
                        <div class="orbit-caption">Caption</div>
                    </li>
                </ul>
            </div>
